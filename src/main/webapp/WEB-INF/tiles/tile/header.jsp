...
<!--                                 </a> -->
           ...
           <a href="#" data-toggle="dropdown" title="myPage" class="header-icon d-flex align-items-center justify-content-center ml-2" >
<!--                                     <img src="/resource/img/pngwing.com.png" class="profile-image rounded-circle" alt="메롱"> -->
                                     <span class="profile-image-md rounded-circle d-block cursor-pointer" onclick="myPage()" style="background-image:url('/resource/img/demo/avatars/avatar-m.png'); background-size: cover;"></span>
                                </a> <!-- 마이페이지 이동 -->
...
<!--                                 </a> 마이페이지 이동 -->
                               ...
                               <a href="#" class="d-flex align-items-center text-white">
                                   ...
                                   <span class="d-inline-block text-truncate text-truncate-sm cursor-default">   ${principal.username} </span>
                                
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="/resource/img/demo/avatars/?????.png" class="rounded-circle profile-image" alt="?????">
                                            </span>
                                            <div class="info-card-text">
                                                <div class="fs-lg text-truncate text-truncate-lg">${principal.username}</div>
                                                <span class="text-truncate text-truncate-md opacity-80">${principal.username}</span>
                                            </div>
                                        </div>
                                    </div>
