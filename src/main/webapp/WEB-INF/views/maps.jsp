 ...
 <div class="modal fade default-example-modal-right" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-right">
                                                    ...
                                                    <input class="form-control" id="example-date1" type="date" name="example-date1" >
                                                     ...
                                                     <button type="button" class="btn btn-xs btn-dark" onclick="reserveList()" style="margin-left: 85%;">찾기</button>
                                                </div>
...
function displayPlaceInfo1 (place) {
 ...
 if(currCategory == 'HP8'){
    content += '<div style="margin-right:10px;" align="right"><button type="button" class="btn btn-warning" data-toggle="modal" data-target=".default-example-modal-right" onclick="reserve()"> 예약  </button></div>';
    }
...
function displayPlaceInfo (place) {
 ...
 content += '    <span class="tel">' + place.phone + '</span>';
//  if(currCategory == 'HP8'){
    content += '<button type="button" class="btn btn-default" data-toggle="modal" data-target=".default-example-modal-right" onclick="reserve()" style="margin-left: 50%;">예약</button>';
//     }
 content += '</div>' + '<div class="after"></div>';
   test = place;
 contentNode.innerHTML = content;
...
//    alert(dd_hospital_name+","+reserveDate);
...
//             $("#close").click();
                        Swal.fire(
                        {
                            title: "<strong>예약 신청되었습니다 :)</strong>",
                            type: "success",
